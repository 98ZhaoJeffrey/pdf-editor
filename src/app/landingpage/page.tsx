    ...
    return (
        <>
            <div className='flex w-full h-screen justify-between' >
                <div className='m-5 sm:mt-12 sm:ml-12 md:ml-20  xl:mt-20 xl:ml-72 max-w-lg'>
                    ...
                    <a className='text-white rounded bg-blue-500 hover:bg-blue-600 py-3 px-4 font-bold cursor-pointer'>Get Started</a>
                    <a className='ml-5 rounded bg-gray-200 hover:bg-gray-300 py-3 px-8 font-bold cursor-pointer'>Login</a>
                </div>
